...
ALTER TABLE member ADD CONSTRAINT member_PK PRIMARY KEY ( mid, mname ) ;


ALTER TABLE board ADD CONSTRAINT board_member_FK FOREIGN KEY ( mid, mname ) REFERENCES member ( mid, mname ) ;

ALTER TABLE boardcomment ADD CONSTRAINT boardcomment_board_FK FOREIGN KEY ( bno ) REFERENCES board ( bno ) ;

ALTER TABLE boardcomment ADD CONSTRAINT boardcomment_member_FK FOREIGN KEY ( mid, mname ) REFERENCES member ( mid, mname ) ;

ALTER TABLE hitcount ADD CONSTRAINT hitcount_board_FK FOREIGN KEY ( bno ) REFERENCES board ( bno ) ;

ALTER TABLE hitcount ADD CONSTRAINT hitcount_member_FK FOREIGN KEY ( mid, mname ) REFERENCES member ( mid, mname ) ;

ALTER TABLE likecount ADD CONSTRAINT likecount_board_FK FOREIGN KEY ( bno ) REFERENCES board ( bno ) ;

ALTER TABLE likecount ADD CONSTRAINT likecount_member_FK FOREIGN KEY ( mid, mname ) REFERENCES member ( mid, mname ) ;
