...
import com.mycompany.myapp.mqtt.Distributor;
import com.mycompany.myapp.mqtt.MqttPublisher;
import com.mycompany.myapp.mqtt.MqttSubscriber;
...
public class HomeController {
	...
	public void login(HttpServletResponse response) throws IOException {
		...
		params.setRedirectUri("http://106.253.56.122:8080/iot1_motion/fb/callback");
	...
	public String callback(@RequestParam("code") String authorizationCode, HttpServletRequest request) {
		...
		AccessGrant accessGrant = oauthOperations.exchangeForAccess(authorizationCode,
				"http://106.253.56.122:8080/iot1_motion/fb/callback", null);
...
//							}
//							//클라이언트 종료
//							publisher.shutdown();								} catch (MqttException e) {
//							// TODO Auto-generated catch block
//							e.printStackTrace();
