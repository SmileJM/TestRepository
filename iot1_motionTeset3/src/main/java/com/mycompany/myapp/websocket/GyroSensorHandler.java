...
//			System.out.println("mid: " + mid);
	...
	public void init() throws MqttException {
		...
		this.topicRequest = "/+/gyro/request";
		this.topicResponse = "/+/gyro/response";
...
//		this.topicResponse = "/2004323883124516/gyro/response";
	...
	public void afterConnectionEstablished(WebSocketSession session) throws Exception {
		...
		this.myClientId = MqttClient.generateClientId();
		this.topicRequest = "/"+mid+"/gyro/request";
		this.topicResponse = "/"+mid+"/gyro/response";
