...
//        File file = getFile();
        processFile(-56.294493723237586,  866.1898416974436,  17.92775280244367);
        fromQueue = true;
        changeButtonStatus(false);
    }
    ...
    private void processFile(double x, double y, double z) {

        String strData = x + "  " + y + "  " + z;
//        while (true) {
            Coordinate c = InputParser.getCoord(strData);
            coordinateQueue.add(c);
//        }
