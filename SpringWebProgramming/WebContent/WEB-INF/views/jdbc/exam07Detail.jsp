			...
			$.ajax({
				...
				success: function(data) {
					if(data.result =="success") {
						// console.log("success");
						location.href="exam07Update?type=${param.type }&bno=${board.bno}";
					} else {
						$("#bpassword").val("");
						$("#bpassword").attr("placeholder", "비밀번호를 입력하셔야 합니다.");
						$("#bpassword").focus();
		...
		function handleBtnDelete() {
			...
			$.ajax({	
				...
				success: function(data) {
					if(data.result =="success") {
						console.log("success");
						location.href="exam07Delete?type=${param.type }&bno=${board.bno}";
					} else {
						$("#bpassword").val("");
						$("#bpassword").attr("placeholder", "비밀번호를 입력하셔야 합니다.");
						$("#bpassword").focus();
...
<body>
	...
	<form method="post"  style="padding: 0px 20px"
		...
		<div class="form-group" style="text-align: center;">
			<img src="exam07Image?bno=${board.bno }" style="max-width: 980px;"/>
		</div>
		<div class="form-group" style="text-align: center;">
		...
		<div class="form-group" align="right">
			...
			<a href="exam07List?type=${param.type }" class="btn btn-primary" >목록</a>
