...
<script type="text/javascript">
	...
	function leave() {
		if (confirm("정말 탈퇴하시겠습니까?") == true) { // 확인
			$.ajax({
				url : "http://106.253.56.122:8080/iot1_motion/leave",
				method : "post",
				data : {
					"mid" : "${member.mid}"
				},
				success : function(data) {
					...
					location.href = "http://106.253.56.122:8080/iot1_motion/"
				...
				<div class="collapse navbar-collapse">
					<div id="menu-container">
						<div style="text-align: center; margin-right: 100px; float: left">
							<a style="line-height: 2" href="http://106.253.56.122:8080/iot1_motion/"> IoT0619 </a>
						</div>
