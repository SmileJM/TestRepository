...
public class AccelAngle {
    ...
    public int getAcclAngleX() {
        acclX = readWord2C(0x3B);
        
//        acclX = (int)(acclX/95.445);
        if (acclX > 360) {
            acclX = 360;
        } else if (acclX < 0) {
            acclX = 360+acclX;
        }
        System.out.println("X: " + acclX);
        return acclX;
    }
    ...
    public int getAcclAngleZ() {
        acclZ = readWord2C(0x3F);
        if (acclZ > 16000) {
            acclZ = (int)(16000/44.445);
        } else if (acclZ < -16000) {
            acclZ = -(int)(16000/44.445);
        }
        return acclZ;
    ...
    public static void main(String[] args) throws Exception {
        AccelAngle gyro = new AccelAngle();
        gyro.init();
        ...
        while (true) {
            directionX = gyro.getAcclAngleX();
            directionY = gyro.getAcclY();
            directionZ = gyro.getAcclAngleZ();
//            Thread.sleep(10);
