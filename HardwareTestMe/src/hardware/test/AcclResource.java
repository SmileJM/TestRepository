...
public class AcclResource extends CoapResource {
    //Field

    private static final Logger logger = LoggerFactory.getLogger(AcclResource.class);
    private int acclX;
    private int acclY;
    private int acclZ;

    public AcclResource() throws Exception {
        super("mouse");
    }
